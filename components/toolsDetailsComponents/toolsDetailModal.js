...
import { Avatar, Button,  Skeleton, Textarea,  Modal,
  ModalBody,
  ModalContent,
  ModalFooter,
  ModalHeader, } from "@nextui-org/react";
...
import { useFetchToolPerformanceRecordsQuery, useGetToolEarningAndAnalyticsQuery } from "@/app/lib/features/admin/adminApi";
import CreateToolsModel from "../marketplace/AddToolModel";
import CancelSubscriptionModal from "../chat/typedChatComponents/CancelSubscriptionModal";
// import { useFetchToolPerformanceRecordsQuery, useGetToolEarningAndAnalyticsQuery } from "@/app/lib/features/admin/adminApi";

const ToolsDetailsModal = ({tool_id,showtoolDetailModal,setShowtoolDetailModal}) => {
  ...
  return (
    <>    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-40"></div>
      <Modal
      placement="center"
        isOpen={showtoolDetailModal}
        onClose={() => setShowtoolDetailModal(false)}
        ...
        className="bg-[#171717]"
      >
        <ModalContent className="max-h-[70vh] overflow-y-auto  py-5 scrollbar-hide">
    <>
      <div className="w-full xl:max-w-[900px] lg:max-w-[920px] min-[1700px]:max-w-[1300px] mx-auto pb-1 px-5">
            ...
            <div className="text-white ">
              <div className="flex gap-3 items-center text-center min-[1700px]:mb-[22px] mb-5">
                ...
                {getToolDetailsGuestLoading ? (
                  ...
                  <p className="text-[32px] text-white font-helvetica font-bold">
                  ...
                  {IsAdmin ? (
                    ...
                    <>
                      <div className="flex gap-[10px] items-center">
                        ...
                        {getToolDetailsGuestData?.tool?.price?.per_use > 0 && (<>
                         <p className="text-sm text-[#B9B9B9] font-medium">Or</p>
                        <p className="text-[#B9B9B9] text-sm font-medium">${getToolDetailsGuestData?.tool?.price?.per_use} Per Use</p></>)}
                      </div>

                      {getToolDetailsGuestData?.tool?.free_trial?.query > 0 && <p className="text-[#BABABA] text-xs my-2">
        ...
        <div>
          <div className="pb-12">
            <div className="mt-6 admin-details-tab">
              <div className="w-full xl:max-w-[900px] lg:max-w-[920px] min-[1700px]:max-w-[1300px] mx-auto relative">
              <div className=" gap-9 ">
              <div className="">
                <Tabs className="hello"
                  activeKey={activeTab}
                  onChange={(key) => setActiveTab(key)}
                >
                  <hr color="#3C3C3C"/>
                  <Tabs.TabPane key="about" tab="About" className="flex gap-x-12 px-5 ">
                    {/* About content here */}
                    <div className="text-white text-sm font-helvetica font-medium pb-12 w-[65%]">
                ...
                <div className="w-[35%]">
                  ...
                  <Tabs.TabPane key="comments" tab="Comments" className="flex gap-x-12 px-5">
                    {/* About content here */}
                    <div className="w-[65%]">
...
{IsAdmin &&
                  <Tabs.TabPane key="admin" tab="Admin" className="flex gap-x-12 px-5">
                    {/* Admin content here */}
                    <div className="text-white text-sm font-helvetica font-medium pb-3 w-[65%]">
                      <AdminStatusBar
