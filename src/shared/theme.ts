  ...
  components: {
      ...
      classNames: (_theme, props) => ({
        input: clsx(
          props.error
            ...
            : 'focus:shadow-ring-brand-shadow-xs border-gray-300 focus:border-brand-300',
          'rounded-[8px] placeholder:text-gray-500 h-11 shadow-input text-md-regular'
        ),
        label: 'text-sm leading-5 font-medium	 text-gray-700 mb-1.5',
        root: 'relative',
        wrapper: '!mb-0',
        error: clsx({ 'text-error-600': props.error }, 'mt-1.5 absolute -bottom-5'),
      }),
    }),
    ...
    Input: Input.extend({
      classNames: (_theme, props) => ({
        ...
        label: 'text-sm-medium text-gray-700 mb-1.5',
        root: 'relative',
        wrapper: '!mb-0',
        error: clsx({ 'text-error-600': props.error }, 'mt-1.5 absolute -bottom-5'),
      }),
    ...
    PasswordInput: PasswordInput.extend({
      classNames: (_theme, props) => ({
        ...
        root: 'relative',
        wrapper: '!mb-0',
        error: clsx({ 'text-error': props.error }, 'mt-1.5 absolute -bottom-5'),
      }),
    }),
    TagsInput: TagsInput.extend({
      classNames: (_theme, props) => ({
        input: clsx(
          props.error
          ? 'border-[#F04438] focus-within:shadow-error text-gray-900 placeholder:text-gray-500'
          : 'focus-within:shadow-ring-brand-shadow-xs border-gray-300 focus-within:border-brand-300',
          'rounded-[8px] placeholder:text-gray-500 shadow-input text-md-regular py-2 min-h-11 h-auto'
        ),
        label: 'text-sm leading-5 font-medium		text-gray-700 mb-1.5',
        pill: 'bg-transparent border-gray-300 border border-solid rounded-md h-6 text-base font-semibold text-gray-700',
      ...
      classNames: (_theme, props) => ({
        input: clsx(
          props.error
            ? 'border-[#F04438] focus:shadow-error text-gray-900 placeholder:text-gray-500'
            : 'focus:shadow-ring-brand-shadow-xs border-gray-300 focus:border-brand-300',
          'rounded-lg placeholder:text-gray-500 h-11 shadow-input text-md-regular'
        ),
        label: 'text-sm leading-5 font-medium	 text-gray-700 mb-1.5',
        root: 'relative',
        wrapper: '!mb-0',
    ...
    Switch: Switch.extend({
      classNames: (_theme, props) => ({
        track: clsx(props.checked && '!bg-brand-970'),
      }),
    }),
    Checkbox: Checkbox.extend({
      classNames: (_theme, props) => ({
        input: clsx(props.checked && '!bg-[#3E4784]'),
      }),
    }),
  },
});
