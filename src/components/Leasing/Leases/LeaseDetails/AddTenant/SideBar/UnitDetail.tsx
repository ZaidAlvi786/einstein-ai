...
const UnitDetail = () => {
  return (
    <div className="px-8 pt-12 pb-14 bg-gradient-brand-60050090-deg relative">
            <div className="bg-white border border-solid border-[1px] border-Gray-blue-300 rounded-[12px] drop-shadow-xs  p-6">
              <div>
                <div className="text-Gray-900 text-base font-semibold leading-6 mb-0.5">
                  Whitestone Apartments
                </div>
                <div className="text-2xl text-Gray-900 leading-8 font-semibold">
                  Unit 101
                  </div>
