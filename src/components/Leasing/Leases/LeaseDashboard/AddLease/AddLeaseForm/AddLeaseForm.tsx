import { ArrowDown, Delete01, Edit01Icon, EmailIcon02, PlusIcon, SvgDefaultUser01, Users01Icon } from '@assets/iconComponents';
import { Badge, Button, Checkbox, Radio, Select, Switch } from '@mantine/core';
...
import { tenatDetailSchema } from '@components/Properties/Tenant/schema';
...
const AddLeaseForm = ({ step, handlers }: Props) => {
