...
interface AcceptionCancelledModalProps {
  open: boolean;
  onClose: () => void;
}
...
export const AcceptionCancelledModal: React.FC<AcceptionCancelledModalProps> = ({
  open,
  onClose,
}) => {
          ...
          <Box className="flex flex-col gap-3">
            ...
            <Box component="label" className="flex gap-4">
              ...
              <Box className="flex flex-1 flex-col">
                ...
                <Text className="text-Gray-600 font-normal text-[14px] leading-[20px]">
                  Decline tenant and close application.
                </Text>
              </Box>
            </Box>
            ...
            <Box component="label" className="flex gap-4">
              ...
              <Box className="flex flex-1 flex-col">
                ...
                <Text className="text-Gray-600 font-normal text-[14px] leading-[20px]">
                  Let tenant know that are declined, (you will be able to etid the masage on the
                  next screen).
                </Text>
              </Box>
            </Box>
