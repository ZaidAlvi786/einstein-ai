    ...
    <Card className="max-w-[421px] w-full shadow-modal bg-[#171717] rounded-[22px]">
      <form onSubmit={handleSubmit}>
        ...
        <CardBody className="px-[18px]">
          ...
          <div className="flex justify-start pl-1 items-center my-auto mt-[20px] gap-x-2">
            <input
              ...
              type="checkbox"
              className="cursor-pointer w-[17px] h-[17px] rounded-sm"
            />
            <p className="text-[#818181] font-helvetica">
              Agree to{" "}
